        ...
        <div className="relative">
            ...
            {isOpen && (
                <>
                    ...
                    <div className={`absolute z-50 mt-2 ${align === 'right' ? 'right-0' : 'left-0'} bg-industrial-900 border border-industrial-700 rounded-lg shadow-xl p-4 w-64`}>
                        {/* Palette Tabs */}
                        <div className="flex gap-2 mb-4 border-b border-industrial-800 pb-2">
                        ...
                        <div className="space-y-3">
                            {Object.entries(PALETTES[selectedPalette]).map(([_name, colors]) => (
                                <div key={_name}>
                                    <div className={`grid gap-2 ${colors.length <= 5 ? 'grid-cols-5' : 'grid-cols-5'}`}>
